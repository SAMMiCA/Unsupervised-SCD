...
parser.add_argument('--path', type=str, default='./result/nyc_taxi',
                    help='file path ')
parser.add_argument('--out', type=str, default='fig.gif',
                    help='file path ')
...
images = []
filenames = natsorted(glob.glob(args.path+'/*'))
...
imageio.mimsave(os.path.join(args.path,args.out),images,duration=0.1)
